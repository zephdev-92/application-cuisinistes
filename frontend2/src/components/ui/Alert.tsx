...
export const Alert: React.FC<AlertProps> = ({ type, title, message, onClose, className = '' }) => {
  ...
  return (
    <div
      className={`rounded-md border ${borderColors[type]} ${bgColors[type]} p-4 ${className}`}
      role="alert"
    >
      <div className="flex">
          ...
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                onClick={onClose}
                className={`inline-flex rounded-md p-1.5 ${bgColors[type]} ${textColors[type]} hover:bg-opacity-80 focus:outline-none`}
              >
